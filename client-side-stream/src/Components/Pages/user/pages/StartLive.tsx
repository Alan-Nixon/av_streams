        ...
        <div>
            ...
            <form className="max-w-4xl ml-16">
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <input type="text" onChange={(e) => setDetails((rest) => ({ ...rest, Title: e.target.value }))} name="Title" id="floating_email" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <input type="text" onChange={(e) => setDetails((rest) => ({ ...rest, Description: e.target.value }))} name="Description" id="floating_password" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
