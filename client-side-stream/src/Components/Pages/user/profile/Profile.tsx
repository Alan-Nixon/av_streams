...
import { changeChannelName, changeProfileData, changeProfileImage } from '../../../../Functions/userFunctions/userManagement';
    ...
    return (
        <>
            ...
            <div className='completeProfileParentDiv' >
                <p className='text-2xl font-bold uppercase flex' style={{ marginLeft: "8%", marginTop: "7%" }}>
