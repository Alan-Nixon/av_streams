                    ...
                    <form className="max-w-lg me-auto">
                        <div className="flex">
                            <div className="relative w-full">
                                <input onChange={findFollowers} type="search" placeholder="Search followers, following ..." style={{ minWidth: "400px" }} id="search-dropdown" className="block p-2.5 z-20 text-sm bg-gray-50 rounded-lg border-s-2 border focus:ring-blue-500cbg-gray-700 border-s-gray-700  border-gray-600 placeholder-gray-400 text-white focus:border-blue-500" required />
                            </div>
                        </div>
                    </form>
                </div>
        ...
        return (<>
            <div className="flex">
                ...
                <div className="ml-12 mt-5 mb-5 w-full">
                    <div style={{ width: "90%" }} className=" p-4 border rounded-lg shadow sm:p-8 bg-gray-800 border-gray-700">
                        <div className="flex items-center justify-between mb-4">
                            <h5 className={"text-xl font-bold leading-none text-white"}>{section?.title}</h5>
